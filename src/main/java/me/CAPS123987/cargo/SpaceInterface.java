    ...
    public BlockPlaceHandler BlockPlaceHandler() {
        return new BlockPlaceHandler(false) {
            ...
            public void onPlayerPlace(BlockPlaceEvent e) {
                ...
                Vector v = null;
				Vector v1 = null;
				try {Directional bmeta = (Directional) b1.getBlockData();
                 v = Calculator.fac(bmeta.getFacing().toString());
                 v1 = Calculator.fac(bmeta.getFacing().toString());}catch(Exception e1) {
                ...
                BlockStorage.addBlockInfo(in.getBlock(), "world", b1.getLocation().getWorld().getName());
                ...
                BlockStorage.addBlockInfo(out.getBlock(), "world", b1.getLocation().getWorld().getName());
